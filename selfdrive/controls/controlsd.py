...
class Controls:
  ...
  def publish_logs(self, CS, start_time, actuators, lac_log):
    ...
    if len(speeds) > 1:
      ...
      v_future = 100.0
      v_future_a = 100.0
    v_future_speed= float((v_future * CV.MS_TO_KPH + 10) if IS_KPH else (v_future * CV.MS_TO_MPH))
    v_future_speed_a= float((v_future_a * CV.MS_TO_KPH + 10) if IS_KPH else (v_future_a * CV.MS_TO_MPH))
